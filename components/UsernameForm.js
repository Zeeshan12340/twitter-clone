    ...
    return (
        <div className="flex h-screen items-center justify-center">
            <form className="text-center text-xl" onSubmit={handleSubmit}>
                ...
                <input type="text" className="block mb-1 bg-socialLightGrey px-3 py-1 rounded-full text-center text-black" placeholder={'username'} value={username} onChange={e => setUsername(e.target.value)} />
